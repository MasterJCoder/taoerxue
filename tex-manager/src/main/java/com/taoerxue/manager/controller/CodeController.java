...
import com.taoerxue.util.CookieUtils;
...
public class CodeController {
    ...
    public void getCode(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        jedisClient.setAndExpire("verificationCode:" + token, randomCode.toString(), 30, TimeUnit.MINUTES);
        CookieUtils.setCookie(request, response, "smsToken", token);
        // 禁止图像缓存。
